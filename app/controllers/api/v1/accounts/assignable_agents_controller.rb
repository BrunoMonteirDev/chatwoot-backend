class Api::V1::Accounts::AssignableAgentsController < Api::V1::Accounts::BaseController
  ...
  def index
    ...
    agents = Current.account.users.without_system_accounts.where(id: agent_ids)
    @assignable_agents = (agents + Current.account.administrators.without_system_accounts).uniq
